...
output_filename = os.path.join(script_directory, "rectangle_with_hole.vtk")
...
lc = 0.05 # Using a slightly finer mesh to better resolve the circle
domain_width = 1.5
domain_height = 1.0
...
# --- NEW: Define the circular hole in the middle ---
...
cl_hole = gmsh.model.occ.addCurveLoop([arc1, arc2, arc3, arc4])

# --- MODIFIED: Create the Plane Surface with the hole ---

# The addPlaneSurface function takes a list of curve loops.
# The first loop is the outer boundary. The following loops are holes.
s = gmsh.model.occ.addPlaneSurface([cl_outer, cl_hole])
